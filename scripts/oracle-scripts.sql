...
CREATE TABLE shop_order(
    ...
    paid NUMBER(1, 0) DEFAULT 1 CHECK (paid IN (0, 1));,
    PRIMARY KEY(id)
);
...
--Test function
-- DECLARE
--     v_order_lines order_line_list := order_line_list();
-- BEGIN
--     v_order_lines.EXTEND(2); -- Extend the array to accommodate two order lines
--     v_order_lines(1) := order_line_type(1, 4); -- Example order line 1: product_item_id = 101, quantity = 2
--     v_order_lines(2) := order_line_type(3, 10); -- Example order line 2: product_item_id = 102, quantity = 3

--     Create_Order(
--         p_user_id => 1,
--         p_payment_method => 'Wallet',
--         p_shipping_address => '123 Main St, City, Country',
--         p_shipping_method_id => 1,
--         p_order_total => 150.00,
--         p_order_status => 'Completed',
--         p_order_lines => v_order_lines,
--         p_paid => 1
--     );
-- END;
-- /
