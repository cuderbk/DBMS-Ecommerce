...
CREATE TABLE product_category (
    ...
    CONSTRAINT fk_parent_category_id FOREIGN KEY (parent_category_id) REFERENCES product_category(id) ON DELETE CASCADE,
    PRIMARY KEY(id)
);
...
CREATE TABLE product (
    ...
    CONSTRAINT fk_product_category_id FOREIGN KEY (category_id) REFERENCES product_category(id) ON DELETE SET NULL,
    PRIMARY KEY(id)
);
...
CREATE TABLE promotion_category (
    category_id NUMBER,
    promotion_id NUMBER,
    CONSTRAINT fk_promotion_category_id FOREIGN KEY (category_id) REFERENCES product_category(id) ON DELETE SET NULL,
    CONSTRAINT fk_promotion_id FOREIGN KEY (promotion_id) REFERENCES promotion(id) ON DELETE SET NULL
);
...
CREATE TABLE variation (
    ...
    name VARCHAR2(100),
    PRIMARY KEY(id),
    CONSTRAINT fk_variation_category FOREIGN KEY (category_id) REFERENCES product_category(id) ON DELETE SET NULL
);
...
CREATE TABLE variation_option (
    ...
    value VARCHAR2(100),
    PRIMARY KEY(id),
    CONSTRAINT fk_variation_id FOREIGN KEY (variation_id) REFERENCES variation(id) ON DELETE CASCADE
);

CREATE TABLE product_configuration (
    product_item_id NUMBER,
    variation_option_id NUMBER,
    CONSTRAINT fk_pc_product_item_id FOREIGN KEY (product_item_id) REFERENCES product_item(id) ON DELETE CASCADE,
    CONSTRAINT fk_pc_variation_option_id FOREIGN KEY (variation_option_id) REFERENCES variation_option(id) ON DELETE SET NULL,
    CONSTRAINT pk_pc_product_configuration PRIMARY KEY (product_item_id, variation_option_id)
);
alter table product disable constraint fk_product_category_id;
alter table product_category disable constraint fk_parent_category_id;
alter table product_item disable constraint fk_product_id;
alter table promotion_category disable constraint fk_promotion_id;
alter table promotion_category disable constraint fk_promotion_category_id;
alter table variation disable constraint fk_variation_category;
alter table variation_option disable constraint fk_variation_id;
--alter table product_configuration disable constraint fk_variation_option_id;
--alter table product_configuration disable constraint fk_product_item_id;
